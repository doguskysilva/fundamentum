...
class TestMockHttpTransport:
    ...
    def test_register_multiple_responses(self, mock_transport):
        ...
        response1 = transport.handle_request(httpx.Request("GET", "https://api.test/users/1"))
        response2 = transport.handle_request(httpx.Request("GET", "https://api.test/users/2"))
    ...
    def test_register_different_methods(self, mock_transport):
        ...
        get_response = transport.handle_request(httpx.Request("GET", "https://api.test/resource"))
        post_response = transport.handle_request(httpx.Request("POST", "https://api.test/resource"))
    ...
    def test_register_custom_status_code(self, mock_transport):
        ...
        transport = mock_transport.build()
        response = transport.handle_request(httpx.Request("GET", "https://api.test/not-found"))
    ...
    def test_register_list_response(self, mock_transport):
        ...
        transport = mock_transport.build()
        response = transport.handle_request(httpx.Request("GET", "https://api.test/users"))
    ...
    def test_unregistered_request_raises_error(self, mock_transport):
        ...
        with pytest.raises(RuntimeError, match="No mock registered for GET"):
            transport.handle_request(httpx.Request("GET", "https://api.test/unregistered"))
...
class TestMockEndpointHelper:
    ...
    def test_mock_simple_endpoint(self, mock_transport, service_registry, endpoint_registry):
        ...
        transport = mock_transport.build()
        response = transport.handle_request(httpx.Request("GET", "https://census.test/api/users"))
    ...
    def test_mock_post_endpoint(self, mock_transport, service_registry, endpoint_registry):
        ...
        transport = mock_transport.build()
        response = transport.handle_request(httpx.Request("POST", "https://census.test/api/users"))
...
class TestServiceClientWithMockTransport:
    ...
    def test_client_post_with_mock(self, mock_transport, endpoint_registry, service_registry):
        ...
        response = run(client.post("census.create_user", body=request_body))
    ...
    def test_client_404_error_with_mock(self, mock_transport, endpoint_registry, service_registry):
    ...
    def test_client_500_error_with_mock(self, mock_transport, endpoint_registry, service_registry):
    ...
    def test_multiple_requests_with_mock(self, mock_transport, endpoint_registry, service_registry):
